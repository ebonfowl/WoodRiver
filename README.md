...
- **Weeks 1-2:** Get technology setup with Anthony including access to paid GitHub Copilot, Python or R interpreter, an integrated development environment for coding work and agentic development, and a shared online repository.
- **Weeks 3-4:** Develop and test a program in Python or R, depending on comfort level, using `ellmer` or `PydanticAI` to utilize API calls to extract parameters from the complete scholarship database.
- **Weeks 5-6:** *Time-permitting*, we will develop a GUI application that can take a student parameter or parameters and output a list of scholarships that student qualifies for.
